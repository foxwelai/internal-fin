  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border bg-background/85 backdrop-blur-md">
      <div className="flex h-14 items-center gap-2 px-3 sm:px-6">
        {/* Compact brand for the mobile header, where there is no sidebar.
            Below `sm` the mark alone carries it — the row is tight at 390px. */}
        <Link href="/overview" className="flex shrink-0 items-center gap-2 lg:hidden">
